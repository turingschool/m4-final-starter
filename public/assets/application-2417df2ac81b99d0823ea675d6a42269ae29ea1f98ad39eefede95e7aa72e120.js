...
function filterTypeLinks() {
  ...
  for (i = 0; i < links.length; i++) {
    var linkTitle = links[i].innerText.replace(/\s/g, ' ').split(' ')[2];
    var linkURL = links[i].innerText.replace(/\s/g, ' ').split(' ')[5];
...
function filterReadLinks() {
  ...
  for (i = 0; i < links.length; i++) {
    var readStatus = links[i].innerText.replace(/\s/g, ' ').split(' ')[8];
...
function filterUnreadLinks() {
  ...
  for (i = 0; i < links.length; i++) {
    var unreadStatus = links[i].innerText.replace(/\s/g, ' ').split(' ')[8];
